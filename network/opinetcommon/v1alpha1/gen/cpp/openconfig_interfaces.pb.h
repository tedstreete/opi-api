...
class State final :
 ...
 public:
  ...
  // .opi_api.network.v1alpha1.AdminState admin_state = 8;
  void clear_admin_state();
  ::opi_api::network::v1alpha1::AdminState admin_state() const;
  void set_admin_state(::opi_api::network::v1alpha1::AdminState value);
  private:
  ::opi_api::network::v1alpha1::AdminState _internal_admin_state() const;
  void _internal_set_admin_state(::opi_api::network::v1alpha1::AdminState value);
  public:
...
inline ::opi_api::network::v1alpha1::AdminState State::_internal_admin_state() const {
  return static_cast< ::opi_api::network::v1alpha1::AdminState >(admin_state_);
}
inline ::opi_api::network::v1alpha1::AdminState State::admin_state() const {
  // @@protoc_insertion_point(field_get:opi_api.network.v1alpha1.State.admin_state)
  return _internal_admin_state();
}
inline void State::_internal_set_admin_state(::opi_api::network::v1alpha1::AdminState value) {
  
  admin_state_ = value;
}
inline void State::set_admin_state(::opi_api::network::v1alpha1::AdminState value) {
...
template <> struct is_proto_enum< ::opi_api::network::v1alpha1::AdminState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::opi_api::network::v1alpha1::AdminState>() {
  return ::opi_api::network::v1alpha1::AdminState_descriptor();
}

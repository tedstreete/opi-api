...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_openconfig_5finterfaces_2eproto = {
  false, false, 3657, descriptor_table_protodef_openconfig_5finterfaces_2eproto, "openconfig_interfaces.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_admin_state(static_cast<::opi_api::network::v1alpha1::OcAdminState>(val));
        } else
          goto handle_unusual;
        continue;

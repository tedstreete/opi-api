...
public interface StateOrBuilder extends
    // @@protoc_insertion_point(interface_extends:opi_api.network.v1.State)
   ...
   */
  opi_api.network.v1.AdminState getAdminState();
   ...
   */
  opi_api.network.v1.OperState getOperState();
   ...
   * @return The counters.
   */
  opi_api.network.v1.Counters getCounters();
  /**
   * <pre>
   * Interface Statistics Counters
   * </pre>
   ...
   * <code>.opi_api.network.v1.Counters counters = 14;</code>
   */
  opi_api.network.v1.CountersOrBuilder getCountersOrBuilder();
}

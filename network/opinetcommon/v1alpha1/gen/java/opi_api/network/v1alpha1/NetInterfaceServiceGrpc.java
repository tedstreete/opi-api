...
public final class NetInterfaceServiceGrpc {
  ...
  public static final String SERVICE_NAME = "opi_api.network.v1alpha1.NetInterfaceService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<opi_api.network.v1alpha1.GetNetInterfaceRequest,
      opi_api.network.v1alpha1.NetInterface> getGetNetInterfaceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetNetInterface",
      requestType = opi_api.network.v1alpha1.GetNetInterfaceRequest.class,
      responseType = opi_api.network.v1alpha1.NetInterface.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<opi_api.network.v1alpha1.GetNetInterfaceRequest,
      opi_api.network.v1alpha1.NetInterface> getGetNetInterfaceMethod() {
    io.grpc.MethodDescriptor<opi_api.network.v1alpha1.GetNetInterfaceRequest, opi_api.network.v1alpha1.NetInterface> getGetNetInterfaceMethod;
      ...
      synchronized (NetInterfaceServiceGrpc.class) {
        if ((getGetNetInterfaceMethod = NetInterfaceServiceGrpc.getGetNetInterfaceMethod) == null) {
          NetInterfaceServiceGrpc.getGetNetInterfaceMethod = getGetNetInterfaceMethod =
              io.grpc.MethodDescriptor.<opi_api.network.v1alpha1.GetNetInterfaceRequest, opi_api.network.v1alpha1.NetInterface>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetNetInterface"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  opi_api.network.v1alpha1.GetNetInterfaceRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<opi_api.network.v1alpha1.ListNetInterfacesRequest,
      opi_api.network.v1alpha1.ListNetInterfacesResponse> getListNetInterfacesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListNetInterfaces",
      requestType = opi_api.network.v1alpha1.ListNetInterfacesRequest.class,
      responseType = opi_api.network.v1alpha1.ListNetInterfacesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<opi_api.network.v1alpha1.ListNetInterfacesRequest,
      opi_api.network.v1alpha1.ListNetInterfacesResponse> getListNetInterfacesMethod() {
    io.grpc.MethodDescriptor<opi_api.network.v1alpha1.ListNetInterfacesRequest, opi_api.network.v1alpha1.ListNetInterfacesResponse> getListNetInterfacesMethod;
      ...
      synchronized (NetInterfaceServiceGrpc.class) {
        if ((getListNetInterfacesMethod = NetInterfaceServiceGrpc.getListNetInterfacesMethod) == null) {
          NetInterfaceServiceGrpc.getListNetInterfacesMethod = getListNetInterfacesMethod =
              io.grpc.MethodDescriptor.<opi_api.network.v1alpha1.ListNetInterfacesRequest, opi_api.network.v1alpha1.ListNetInterfacesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListNetInterfaces"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  opi_api.network.v1alpha1.ListNetInterfacesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  opi_api.network.v1alpha1.ListNetInterfacesResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<opi_api.network.v1alpha1.UpdateNetInterfaceRequest,
      opi_api.network.v1alpha1.NetInterface> getUpdateNetInterfaceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateNetInterface",
      requestType = opi_api.network.v1alpha1.UpdateNetInterfaceRequest.class,
      responseType = opi_api.network.v1alpha1.NetInterface.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<opi_api.network.v1alpha1.UpdateNetInterfaceRequest,
      opi_api.network.v1alpha1.NetInterface> getUpdateNetInterfaceMethod() {
    io.grpc.MethodDescriptor<opi_api.network.v1alpha1.UpdateNetInterfaceRequest, opi_api.network.v1alpha1.NetInterface> getUpdateNetInterfaceMethod;
      ...
      synchronized (NetInterfaceServiceGrpc.class) {
        if ((getUpdateNetInterfaceMethod = NetInterfaceServiceGrpc.getUpdateNetInterfaceMethod) == null) {
          NetInterfaceServiceGrpc.getUpdateNetInterfaceMethod = getUpdateNetInterfaceMethod =
              io.grpc.MethodDescriptor.<opi_api.network.v1alpha1.UpdateNetInterfaceRequest, opi_api.network.v1alpha1.NetInterface>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateNetInterface"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  opi_api.network.v1alpha1.UpdateNetInterfaceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  opi_api.network.v1alpha1.NetInterface.getDefaultInstance()))
  ...
  public static abstract class NetInterfaceServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getNetInterface(opi_api.network.v1alpha1.GetNetInterfaceRequest request,
        io.grpc.stub.StreamObserver<opi_api.network.v1alpha1.NetInterface> responseObserver) {
     ...
     * </pre>
     */
    public void listNetInterfaces(opi_api.network.v1alpha1.ListNetInterfacesRequest request,
        io.grpc.stub.StreamObserver<opi_api.network.v1alpha1.ListNetInterfacesResponse> responseObserver) {
     ...
     * </pre>
     */
    public void updateNetInterface(opi_api.network.v1alpha1.UpdateNetInterfaceRequest request,
        io.grpc.stub.StreamObserver<opi_api.network.v1alpha1.NetInterface> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                opi_api.network.v1alpha1.GetNetInterfaceRequest,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                opi_api.network.v1alpha1.ListNetInterfacesRequest,
                opi_api.network.v1alpha1.ListNetInterfacesResponse>(
                  this, METHODID_LIST_NET_INTERFACES)))
          .addMethod(
            getUpdateNetInterfaceMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                opi_api.network.v1alpha1.UpdateNetInterfaceRequest,
                opi_api.network.v1alpha1.NetInterface>(
  ...
  public static final class NetInterfaceServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<NetInterfaceServiceBlockingStub> {
     ...
     * </pre>
     */
    public opi_api.network.v1alpha1.NetInterface getNetInterface(opi_api.network.v1alpha1.GetNetInterfaceRequest request) {
     ...
     * </pre>
     */
    public opi_api.network.v1alpha1.ListNetInterfacesResponse listNetInterfaces(opi_api.network.v1alpha1.ListNetInterfacesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public opi_api.network.v1alpha1.NetInterface updateNetInterface(opi_api.network.v1alpha1.UpdateNetInterfaceRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class NetInterfaceServiceFutureStub extends io.grpc.stub.AbstractFutureStub<NetInterfaceServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<opi_api.network.v1alpha1.NetInterface> getNetInterface(
        opi_api.network.v1alpha1.GetNetInterfaceRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<opi_api.network.v1alpha1.ListNetInterfacesResponse> listNetInterfaces(
        opi_api.network.v1alpha1.ListNetInterfacesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<opi_api.network.v1alpha1.NetInterface> updateNetInterface(
        opi_api.network.v1alpha1.UpdateNetInterfaceRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_NET_INTERFACE:
          serviceImpl.getNetInterface((opi_api.network.v1alpha1.GetNetInterfaceRequest) request,
              (io.grpc.stub.StreamObserver<opi_api.network.v1alpha1.NetInterface>) responseObserver);
          break;
        case METHODID_LIST_NET_INTERFACES:
          serviceImpl.listNetInterfaces((opi_api.network.v1alpha1.ListNetInterfacesRequest) request,
              (io.grpc.stub.StreamObserver<opi_api.network.v1alpha1.ListNetInterfacesResponse>) responseObserver);
          break;
        case METHODID_UPDATE_NET_INTERFACE:
          serviceImpl.updateNetInterface((opi_api.network.v1alpha1.UpdateNetInterfaceRequest) request,
              (io.grpc.stub.StreamObserver<opi_api.network.v1alpha1.NetInterface>) responseObserver);
          break;
        default:
  ...
  private static abstract class NetInterfaceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return opi_api.network.v1alpha1.OpenconfigInterfacesProto.getDescriptor();
    }

...
const uint32_t TableStruct_backend_5fnvme_5ftcp_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::opi_api::storage::v1::NVMfRemoteController, num_io_queues_),
...
const char descriptor_table_protodef_backend_5fnvme_5ftcp_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ponse\"\000B7Z5github.com/opiproject/opi-api"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_backend_5fnvme_5ftcp_2eproto = {
  false, false, 2392, descriptor_table_protodef_backend_5fnvme_5ftcp_2eproto, "backend_nvme_tcp.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 80)) {
          num_io_queues_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* NVMfRemoteController::_InternalSerialize(
  ...
  // int64 num_io_queues = 10;
  if (this->_internal_num_io_queues() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(10, this->_internal_num_io_queues(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:opi_api.storage.v1.NVMfRemoteController)
  ...
  // int64 num_io_queues = 10;
  if (this->_internal_num_io_queues() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_num_io_queues());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:opi_api.storage.v1.NVMfRemoteController)
  ...
  if (from._internal_num_io_queues() != 0) {
    _internal_set_num_io_queues(from._internal_num_io_queues());
  }

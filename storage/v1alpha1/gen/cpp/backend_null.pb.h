...
class NullVolume final :
 ...
 public:
  ...
  ~NullVolume() override;
  explicit PROTOBUF_CONSTEXPR NullVolume(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const NullVolume& from) {
    NullVolume::MergeImpl(*this, from);
  }
  private:
...
class CreateNullVolumeRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR CreateNullVolumeRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const CreateNullVolumeRequest& from) {
    CreateNullVolumeRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class DeleteNullVolumeRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR DeleteNullVolumeRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const DeleteNullVolumeRequest& from) {
    DeleteNullVolumeRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class UpdateNullVolumeRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR UpdateNullVolumeRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const UpdateNullVolumeRequest& from) {
    UpdateNullVolumeRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class ListNullVolumesRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ListNullVolumesRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const ListNullVolumesRequest& from) {
    ListNullVolumesRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class ListNullVolumesResponse final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ListNullVolumesResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const ListNullVolumesResponse& from) {
    ListNullVolumesResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class GetNullVolumeRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GetNullVolumeRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const GetNullVolumeRequest& from) {
    GetNullVolumeRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class StatsNullVolumeRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StatsNullVolumeRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const StatsNullVolumeRequest& from) {
    StatsNullVolumeRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class StatsNullVolumeResponse final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StatsNullVolumeResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const StatsNullVolumeResponse& from) {
    StatsNullVolumeResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline const ::opi_api::storage::v1::NullVolume& CreateNullVolumeRequest::_internal_null_volume() const {
  const ::opi_api::storage::v1::NullVolume* p = _impl_.null_volume_;
...
inline void CreateNullVolumeRequest::unsafe_arena_set_allocated_null_volume(
    ::opi_api::storage::v1::NullVolume* null_volume) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.null_volume_);
  }
  _impl_.null_volume_ = null_volume;
  if (null_volume) {
...
inline ::opi_api::storage::v1::NullVolume* CreateNullVolumeRequest::release_null_volume() {
  ...
  ::opi_api::storage::v1::NullVolume* temp = _impl_.null_volume_;
  _impl_.null_volume_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::opi_api::storage::v1::NullVolume* CreateNullVolumeRequest::_internal_mutable_null_volume() {
  ...
  if (_impl_.null_volume_ == nullptr) {
    auto* p = CreateMaybeMessage<::opi_api::storage::v1::NullVolume>(GetArenaForAllocation());
    _impl_.null_volume_ = p;
  }
  return _impl_.null_volume_;
}
...
inline void CreateNullVolumeRequest::set_allocated_null_volume(::opi_api::storage::v1::NullVolume* null_volume) {
  ...
  if (null_volume) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(null_volume);
    if (message_arena != submessage_arena) {
...
void CreateNullVolumeRequest::set_null_volume_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.null_volume_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CreateNullVolumeRequest::release_null_volume_id() {
  ...
  return _impl_.null_volume_id_.Release();
}
inline void CreateNullVolumeRequest::set_allocated_null_volume_id(std::string* null_volume_id) {
  ...
  _impl_.null_volume_id_.SetAllocated(null_volume_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.null_volume_id_.IsDefault()) {
...
inline int ListNullVolumesResponse::_internal_null_volumes_size() const {
  return _impl_.null_volumes_.size();
}
...
inline ::opi_api::storage::v1::NullVolume* ListNullVolumesResponse::mutable_null_volumes(int index) {
  ...
  return _impl_.null_volumes_.Mutable(index);
}
...
inline ::opi_api::storage::v1::NullVolume* ListNullVolumesResponse::_internal_add_null_volumes() {
  return _impl_.null_volumes_.Add();
}

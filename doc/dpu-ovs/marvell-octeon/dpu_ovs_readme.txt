...
# Setup the Octeon as a DPU (PCIE-EP)

# Bind Octeon host VFs to dpdk

dpdk/usertools/dpdk-devbind.py --bind vfio-pci 04:02.0
dpdk/usertools/dpdk-devbind.py --bind vfio-pci 04:02.1
...
################################
# On Target
# Setting up the ovs environment
################################
...
# Configure OVS
# 0. 1st time folder creation:
mkdir -p /usr/local/etc/openvswitch
mkdir -p /usr/local/var/run/openvswitch
mkdir -p /usr/local/var/log/openvswitch

# 1. Removing previous configuration and log
